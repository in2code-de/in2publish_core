...
const baseConfig = createConfig({
  backendUrl: process.env.PLAYWRIGHT_BASE_URL || 'https://local.v14.in2publish-core.de/typo3/',
  login: {
    backend: {
...
export default {
  ...
  foreign: {
    baseUrl: process.env.PLAYWRIGHT_FOREIGN_BASE_URL || 'https://foreign.v14.in2publish-core.de/typo3/',
  },
};
