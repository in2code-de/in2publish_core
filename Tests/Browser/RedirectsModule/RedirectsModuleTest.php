...
class RedirectsModuleTest extends AbstractBrowserTestCase
{
    public function testRedirectWithoutAssociationCanBePublished(): void
    {
        ...
        TYPO3Helper::inContentIFrameContext($localDriver, static function (WebDriver $driver): void {
            ...
            self::assertPageContains($driver, 'Associated redirect Redirect [19] (local.v13.in2publish-core.de) /extin2publish/8-treatremovedanddeletedasdifference -> t3://page?uid=39&_language=0 with site main');
        });
