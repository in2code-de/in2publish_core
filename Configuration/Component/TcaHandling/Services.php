...
use In2code\In2publishCore\Component\TcaHandling\DependencyInjection\PublisherCompilerPass;
...
return static function (ContainerConfigurator $configurator, ContainerBuilder $builder) {
    ...
    $builder->addCompilerPass(new PublisherCompilerPass('in2publish_core.publisher'));
};
