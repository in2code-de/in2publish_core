...
final class RecursiveRecordPublishingBegan
{
     ...
     *     \In2code\In2publishCore\Event\RecursiveRecordPublishingBegan::getRecordPublisher instead.
     */
    public function getCommonRepository(): CommonRepository
    {
        trigger_error(
            'The method \In2code\In2publishCore\Event\RecursiveRecordPublishingBegan::getCommonRepository is deprecated and will be removed in in2publish_core v11, please use \In2code\In2publishCore\Event\RecursiveRecordPublishingBegan::getRecordPublisher instead.',
            E_USER_DEPRECATED
        );
