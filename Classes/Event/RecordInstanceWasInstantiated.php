...
final class RecordInstanceWasInstantiated
{
    ...
    {
        trigger_error(
            'The method \In2code\In2publishCore\Event\RecordInstanceWasInstantiated::getRecordFactory is deprecated. It is not guaranteed that the record was created using the RecordFactory. You can get an instance of the RecordFactory via GeneralUtility::makeInstance or dependency injection if you absolutely need it, it\'s a singleton. This getter will be removed in in2publish_core v11.',
            E_USER_DEPRECATED
        );
