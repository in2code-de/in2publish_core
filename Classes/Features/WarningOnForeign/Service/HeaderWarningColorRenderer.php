...
namespace In2code\In2publishCore\Features\WarningOnForeign\Service;
...
class HeaderWarningColorRenderer
{
    ...
    protected function createCss(string $color): string
    {
        return <<<CSS
...
.topbar-header-site:after, .topbar-header-site:before {
    display: none
}
CSS;
    }
