...
namespace In2code\In2publishCore\Component\TemporaryAssetTransmission\DependencyInjection;
...
class RegisterTransmissionAdapterCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $remoteAdapterRegistry = $container->findDefinition(TransmissionAdapterRegistry::class);
